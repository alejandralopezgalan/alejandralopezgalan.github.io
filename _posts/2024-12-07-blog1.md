...
{% include figure.liquid path="assets/img/blog1-workbiology.jpg" class="img-fluid rounded z-depth-1" %}
Drying wetsuits after diving was part of the work as a marine biologist.
<p>&nbsp;</p>

{% include figure.liquid path="assets/img/blog1-workbiology2.jpg" class="img-fluid rounded z-depth-1" %}
Flying over the Great Barrier Reef is one of my favorite memories.
<p>&nbsp;</p>

{% include figure.liquid path="assets/img/blog1-workbiology3.JPG" class="img-fluid rounded z-depth-1" %}
