...
{% include figure.liquid path="assets/img/blog1-workbiology.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
Drying wetsuits after diving was part of the work as a marine biologist.
<p>&nbsp;</p>

{% include figure.liquid path="assets/img/blog1-workbiology2.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
Flying over the Great Barrier Reef is one of my favorite memories.
<p>&nbsp;</p>

{% include figure.liquid path="assets/img/blog1-workbiology3.JPG" class="img-fluid rounded z-depth-1" zoomable=true %}
I'm very grateful for making friendships that last even after the PhD.
