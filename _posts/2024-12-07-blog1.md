...
<img-comparison-slider>
  {% include figure.liquid path="assets/img/blog1-workbiology.jpg" class="img-fluid rounded z-depth-1" slot="first" %}
  {% include figure.liquid path="assets/img/blog1-workbiology.jpg" class="img-fluid rounded z-depth-1" slot="second" %}
</img-comparison-slider>
