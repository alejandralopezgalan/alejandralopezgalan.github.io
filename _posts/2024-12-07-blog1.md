...
<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/blog1-workbiology.jpg" class="img-fluid rounded z-depth-1" %}Hi</swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/blog1-workbiology2.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/blog1-workbiology3.jpg" class="img-fluid rounded z-depth-1" %}</swiper-slide>
</swiper-container>


<swiper-container keyboard="true" navigation="true" pagination="true" pagination-clickable="true" pagination-dynamic-bullets="true" rewind="true">
  <swiper-slide>{% include figure.liquid path="assets/img/blog1-workbiology.jpg" class="img-fluid rounded z-depth-1" %}Drying the wetsuits after diving is part of the marine biologist work</swiper-slide>
  <swiper-slide>{% include figure.liquid path="assets/img/blog1-workbiology2.jpg" class="img-fluid rounded z-depth-1" %}Flying over thge Great Barrier Reef is one of my favourites memories</swiper-slide>
  <swiper-slide>{% include figure.liquid path="assets/img/blog1-workbiology3.jpg" class="img-fluid rounded z-depth-1" %}Making friendships that last even after the PhD is also something I am very grateful for</swiper-slide>
</swiper-container>
