...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>{% include figure.liquid loading="eager" path="assets/img/Project5-Revenue2007-2008.png" class="img-fluid rounded z-depth-1" %}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Project5-Revenue2007-2008.png">Fig.1</a></td>
        </tr>
        <tr>
...
Consider rationalising the SKU portfolio to eliminate low-profit contributors and enhance overall profitability </td>
            <td>{% include figure.liquid loading="eager" path="assets/img/Project5-Product-Profitability.png" class="img-fluid rounded z-depth-1" %}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Project5-Product-Profitability.png">Fig.2</a></td>
        </tr>
        <tr>
...
This timing strategy enhances impact and revenue potential. </td>
            <td>{% include figure.liquid loading="eager" path="assets/img/Project5-Seasonal-Peaks.png" class="img-fluid rounded z-depth-1" %}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Project5-Seasonal-Peaks.png">Fig.3</a></td>
        </tr>
        <tr>
          ...
          <td>{% include figure.liquid loading="eager" path="assets/img/Project5-Weekday.png" class="img-fluid rounded z-depth-1" %}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Project5-Weekday.png">Fig.4</a></td>
        </tr>
        <tr>
...
Given gender neutrality in profit distribution, campaigns can focus on shared value drivers rather than gender-specific messaging. </td>
            <td>{% include figure.liquid loading="eager" path="assets/img/Project5-age_group.png" class="img-fluid rounded z-depth-1" %}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Project5-age_group.png">Fig.5</a></td>
        </tr>
        <tr> 
...
Focused efforts in these regions can amplify revenue growth and market share. </td>
            <td>{% include figure.liquid loading="eager" path="assets/img/Projct5-au-usa.png" class="img-fluid rounded z-depth-1" %}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Projct5-au-usa.png">Fig.6</a></td>
        </tr>
    </tbody>
</table>
