...
Focused efforts in these regions can amplify revenue growth and market share. </td>
            <td>{% include figure.liquid loading="eager" path="assets/img/Projct5-au-usa.png" class="img-fluid rounded z-depth-1" zoomable=true%}<a href="https://github.com/alejandralopezgalan/alejandralopezgalan.github.io/blob/master/assets/img/Projct5-au-usa.png"><Fig.5/a>
        </tr>
    </tbody>
</table>
